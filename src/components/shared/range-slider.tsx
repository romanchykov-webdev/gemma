	...
	({ className, min, max, step, formatLabel, value, onValueChange, ...props }: SliderProps, ref) => {
		...
		return (
			<SliderPrimitive.Root
				...
				{...props}
			>
				<SliderPrimitive.Track className="relative h-1 w-full grow overflow-hidden rounded-full bg-brand-border">
					<SliderPrimitive.Range className="absolute h-full bg-brand-border" />
