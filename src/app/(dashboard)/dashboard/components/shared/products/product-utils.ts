 ...
 */
export const validateProductData = (data: Partial<CreateProductData> | Partial<UpdateProductData>): string | null => {
 ...
 */
export const getCategoryName = (categoryId: number, categories: Array<{ id: number; name: string }>): string => {
