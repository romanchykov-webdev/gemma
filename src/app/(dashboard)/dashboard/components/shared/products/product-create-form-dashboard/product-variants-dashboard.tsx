	...
	return (
		<div className="border-t pt-3">
			<div className="flex items-center justify-between mb-2">
				<span className="text-sm font-medium">Varianti {variants.length > 0 && `(${variants.length})`}</span>
			...
			{loadingOptions && (
				<div className="text-sm text-gray-500 text-center py-2">Caricamento formati e tipi di impasto...</div>
			)}
