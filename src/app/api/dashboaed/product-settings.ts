...
export const updateProductSize = async (id: number, sizeData: Partial<ProductSize>): Promise<ProductSize> => {
...
export const updateDoughType = async (id: number, typeData: Partial<DoughType>): Promise<DoughType> => {
