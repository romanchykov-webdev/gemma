...
async function up() {
  ...
  await prisma.product.create({
    data: {
      name: '4 Formaggio',
      imageUrl:
        'https://twjhdhfkcwoapajrkakp.supabase.co/storage/v1/object/public/gemma/pizza/4_Formaggio.webp',
      categoryId: 1,
      baseIngredients: [
        { id: 2, ...getIngredient(2), removable: false, isDisabled: false },
  ...
  await prisma.product.create({
    data: {
      name: 'Margherita',
      imageUrl:
        'https://twjhdhfkcwoapajrkakp.supabase.co/storage/v1/object/public/gemma/pizza/Margherita.webp',
      categoryId: 1,
      baseIngredients: [
        { id: 2, ...getIngredient(2), removable: false, isDisabled: false },
        { id: 11, ...getIngredient(11), removable: true, isDisabled: false },
  ...
  await prisma.product.create({
    data: {
      name: 'Pollo e Ananas',
      imageUrl:
        'https://twjhdhfkcwoapajrkakp.supabase.co/storage/v1/object/public/gemma/pizza/Villaggio.webp',
      categoryId: 1,
      baseIngredients: [
        { id: 2, ...getIngredient(2), removable: false, isDisabled: false },
  ...
  await prisma.product.create({
    data: {
      name: 'Vegetariana',
      imageUrl:
        'https://twjhdhfkcwoapajrkakp.supabase.co/storage/v1/object/public/gemma/pizza/Hawaiano.webp',
      categoryId: 1,
      baseIngredients: [
        { id: 2, ...getIngredient(2), removable: false, isDisabled: false },
        { id: 11, ...getIngredient(11), removable: true, isDisabled: false },
  ...
  await prisma.product.create({
    data: {
      name: 'Diavola',
      imageUrl:
        'https://twjhdhfkcwoapajrkakp.supabase.co/storage/v1/object/public/gemma/pizza/6_Formaggi.webp',
      categoryId: 1,
      baseIngredients: [
        { id: 2, ...getIngredient(2), removable: false, isDisabled: false },
        { id: 9, ...getIngredient(9), removable: true, isDisabled: false },
  ...
  await prisma.product.create({
    data: {
      name: 'Carne Mista',
      imageUrl:
        'https://twjhdhfkcwoapajrkakp.supabase.co/storage/v1/object/public/gemma/pizza/4_Carne.webp',
      categoryId: 1,
      baseIngredients: [
        { id: 2, ...getIngredient(2), removable: false, isDisabled: false },
        { id: 7, ...getIngredient(7), removable: true, isDisabled: false },
  ...
  await prisma.product.create({
    data: {
      name: 'Pollo BBQ',
      imageUrl:
        'https://twjhdhfkcwoapajrkakp.supabase.co/storage/v1/object/public/gemma/pizza/Barbecue.webp',
      categoryId: 1,
      baseIngredients: [
        { id: 2, ...getIngredient(2), removable: false, isDisabled: false },
        { id: 5, ...getIngredient(5), removable: true, isDisabled: false },
  ...
  await prisma.$executeRawUnsafe(
    `SELECT setval('"Size_id_seq"', (SELECT COALESCE(MAX(id), 1) FROM "Size"))`,
  );
  await prisma.$executeRawUnsafe(
    `SELECT setval('"Type_id_seq"', (SELECT COALESCE(MAX(id), 1) FROM "Type"))`,
  );
  await prisma.$executeRawUnsafe(
